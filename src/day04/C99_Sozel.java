...
public class C99_Sozel {
    /*
        - clear() : Icerisinde yazi olan web elementini temizler, siler.
        - displayed() : Bir webelementin gorunurlugunu sorgular. Bulmak icin if else icinde yazmaliyiz.
        - NoSuchElementException : Boyle bir web element yok hatasidir.
        Bu hatayi almamizin 2 farkli yolu vardir.
